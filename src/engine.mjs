...
const CATEGORY_RULES = [
  {
    id: "regulation",
    label: "监管与交易所",
    keywords: ["证监会", "交易所", "保证金", "涨跌停", "手续费", "交割", "异常交易", "自律监管", "规则", "公告", "通知"]
  },
  {
    id: "peer",
    label: "同行动态",
  ...
  },
  {
    id: "finance",
    label: "金融要闻",
    keywords: ["央行", "利率", "汇率", "美联储", "美元", "债券", "股票", "金融监管", "地缘", "经济数据", "通胀"]
  },
  {
    id: "variety",
    label: "品种异动",
    keywords: ["涨停", "跌停", "大涨", "大跌", "持仓", "成交", "库存", "仓单", "基差", "原油", "黄金", "铜", "螺纹", "焦煤", "豆粕", "碳酸锂"]
  },
  {
    id: "industry",
    label: "产业资讯",
    keywords: ["供需", "产量", "进口", "出口", "库存", "港口", "矿山", "天气", "种植", "装置", "开工率"]
  }
];
